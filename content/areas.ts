...
export const AREAS: AreaDef[] = [
  ...
  },
  {
    id: 'warriors-guild',
    name: "Warriors' Guild",
    // Shares Falador's plaza art, washed cooler: the guild sits inside the city.
    monsterIds: ['cyclops', 'elder-cyclops'],
    npcIds: [],
    backdrop: '/sprites/areas/falador.png',
    tint: 'rgba(38, 52, 84, 0.34)',
    mapWidth: 765,
    mapHeight: 503,
    playerSpawn: { x: 466, y: 481, scale: 36 },
    spawns: [
      // Cyclopes pace the training floor either side of the monument.
      { id: 'cyclops', kind: 'monster', x: 300, y: 300, scale: 56 },
      { id: 'elder-cyclops', kind: 'monster', x: 470, y: 220, scale: 68 },
    ],
  },
  {
    id: 'barrows',
    name: 'The Barrows',
    // Shares the graveyard art under a colder, greener pall.
    monsterIds: ['ghost-of-barrows', 'ahrim', 'karil', 'torag', 'guthan', 'verac', 'dharok'],
    npcIds: [],
    backdrop: '/sprites/areas/bone-king-graveyard.png',
    tint: 'rgba(24, 58, 44, 0.32)',
    mapWidth: 765,
    mapHeight: 503,
    playerSpawn: { x: 383, y: 480, scale: 36 },
    spawns: [
      // One brother per mound, with guardians on the burial road between them.
      { id: 'ghost-of-barrows', kind: 'monster', x: 300, y: 252, scale: 44 },
      { id: 'ahrim', kind: 'monster', x: 160, y: 240, scale: 52 },
      { id: 'karil', kind: 'monster', x: 226, y: 300, scale: 52 },
      { id: 'torag', kind: 'monster', x: 540, y: 240, scale: 54 },
      { id: 'guthan', kind: 'monster', x: 620, y: 290, scale: 54 },
      { id: 'verac', kind: 'monster', x: 462, y: 258, scale: 54 },
      { id: 'dharok', kind: 'monster', x: 383, y: 135, scale: 60 },
    ],
  },
  {
    id: 'elvargs-lair',
