...
import { showCollectionLogModal, showContextMenu, showShopModal } from './modals';
              ...
              <div class="tab-panels">
                ...
                <div class="tab-content" id="tab-guide" data-tab="guide">
                  ...
                  <div class="inv-hint">
                    ...
                    <b>Right click</b> a pack item for its actions.<br/>
                    <b>Double click</b> food or potions to consume them.
                  </div>
